...
def cut_active_carriers(machine_state: Knitting_Machine) -> list[Releasehook_Instruction | Outhook_Instruction]:
    ...
    Returns:
        list[Release_Hook | Outhook_Instruction]:
            A list containing an optional starting releasehook instruction
            and then the Outhook_Instruction objects that were created and executed to cut all active carriers.
