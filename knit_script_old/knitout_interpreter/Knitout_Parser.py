...
import knit_script_old
from knit_script_old.knitout_interpreter.knitout_actions import action
...
class Knitout_Parser:
    ...
    def __init__(self, debug_grammar: bool = False, debug_parser: bool = False, debug_parser_layout: bool = False):
        pg_resource_stream = importlib_resources.files(knit_script_old.knitout_interpreter).joinpath('knitout.pg')
