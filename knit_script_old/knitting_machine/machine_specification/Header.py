...
from knit_script_old.knit_graphs.Yarn import Yarn
from knit_script_old.knitout_interpreter.knitout_structures.Knitout_Line import Knitout_Line, Version_Line
...
from knit_script_old.knitting_machine.machine_components.machine_position import Machine_Position
from knit_script_old.knitting_machine.machine_components.yarn_management.Carrier_Set import Carrier_Set
from knit_script_old.knitting_machine.machine_specification.Header_ID import Header_ID
...
class Header:
    ...
    def machine_state(self) -> Knitting_Machine:
        ...
        """
        machine_state = Knitting_Machine(self.width, self.carrier_count)
        # TODO: Set Max rack and hook size in virtual knitting machine package.
