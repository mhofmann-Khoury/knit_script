...
class Attribute_Accessor_Expression(Expression):
    ...
    def __init__(self, parser_node, parent_path: list[Expression] | Expression, attribute: Expression):
        """
        Instantiate
        :param parser_node:
    ...
    def _evaluate_parent(self, context: Knit_Script_Context):
        ...
        if isinstance(self.attribute, Variable_Expression):  # variable name, access directly from parent instance
            ...
            if isinstance(attribute, Needle):
                if isinstance(parent, Knitting_Machine):
                    ...
                    return context.machine_state[sheet_needle] # Todo: Update virtual Knitting machine to take sheet needles
            else:
