...
from knit_script_old.knit_script_interpreter.knit_script_actions import action
...
class Knit_Script_Parser:
    ...
    def __init__(self, debug_grammar: bool = False, debug_parser: bool = False, debug_parser_layout: bool = False):
        ...
        pg_resource_stream = importlib_resources.files(knit_script_old.knit_script_interpreter).joinpath('knit_script.pg')
