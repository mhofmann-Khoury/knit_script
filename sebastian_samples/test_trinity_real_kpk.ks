...
//trinity stitch pattern (aka Raspberry or Blackberry) but with real (k1, p1, k1)
...
with Carrier as c1:{
    ...
    //for layer2
    xfer_p3tog_l2 = [n for n in Front_Needles[3:width:4]];
    knit_p3tog_l2 = [n for n in Back_Needles[3:width:4]];
    split_p_l2 = [n for n in Back_Needles[1:width:4]];
    split_k2_l2 = [n for n in Front_Needles[2:width:4]];
    xfer_front_k2_l2 = [n for n in Front_Needles[0:width:4]];
    xfer_back_k2_l2 = [n for n in Back_Needles[2:width:4]];
    knit_k1_l2 = [n for n in Front_Needles[0:width:4]];

    //for layer4
    xfer_p3tog_l4 = [n for n in Front_Needles[0:width:4]];
    knit_p3tog_l4 = [n for n in Back_Needles[0:width:4]];
    split_p_l4 = [n for n in Back_Needles[2:width:4]];
    split_k_l4 = [n for n in Front_Needles[1:width:4]];
    xfer_front_k2_l4 = [n for n in Front_Needles[3:width:4]];
    xfer_back_k2_l4 = [n for n in Back_Needles[1:width:4]];
    knit_k1_l4 = [n for n in Front_Needles[1:width:4]];
    ...
    for i in range(0, height):{
        ...
        if count == 2:{
            ...
            xfer xfer_p3tog_l2 across to Back bed;
            xfer xfer_front_k2_l2 2 to Rightward to Back bed;
            xfer xfer_back_k2_l2 across;
            ...
            print("set racking:");
            r = rackNeedles.rackVal(Front_Needles[2], Back_Needles[1]);

            //**ISSUE**
            racking = r;
            
            //print(r);
            //r = rackNeedles.rackVal(Front_Needles[1], Back_Needles[2]);
            //print(r);
        ...
        if count == 4:{
            ...
            xfer xfer_p3tog_l4 across to Back bed;
            xfer xfer_front_k2_l4 2 to Leftward to Back bed;
            xfer xfer_back_k2_l4 across;
            //xfer xfer_k2_l4 2 to Leftward to Front bed;
